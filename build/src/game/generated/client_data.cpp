...
static CAnimKeyframe x5105[] = {
	/* x5105[0] */ {  0.000000f,  0.000000f,  -4.000000f,  0.000000f, },
};
static CAnimKeyframe x5112[] = {
	/* x5112[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe x5119[] = {
	/* x5119[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe *x5126 = 0;
static CAnimKeyframe *x5150 = 0;
static CAnimKeyframe x5157[] = {
	/* x5157[0] */ {  0.000000f,  -7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x5164[] = {
	/* x5164[0] */ {  0.000000f,  7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe *x5171 = 0;
static CAnimKeyframe *x5190 = 0;
static CAnimKeyframe x5197[] = {
	/* x5197[0] */ {  0.000000f,  -3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x5204[] = {
	/* x5204[0] */ {  0.000000f,  3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x5211 = 0;
static CAnimKeyframe x5230[] = {
	/* x5230[0] */ {  0.000000f,  0.000000f,  3.000000f,  0.000000f, },
};
static CAnimKeyframe x5237[] = {
	/* x5237[0] */ {  0.000000f,  -12.000000f,  0.000000f,  0.100000f, },
};
static CAnimKeyframe x5244[] = {
	/* x5244[0] */ {  0.000000f,  -8.000000f,  0.000000f,  0.100000f, },
};
static CAnimKeyframe *x5251 = 0;
static CAnimKeyframe x5275[] = {
	/* x5275[0] */ {  0.000000f,  0.000000f,  3.000000f,  0.000000f, },
};
static CAnimKeyframe x5282[] = {
	/* x5282[0] */ {  0.000000f,  12.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x5289[] = {
	/* x5289[0] */ {  0.000000f,  8.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x5296 = 0;
static CAnimKeyframe x5320[] = {
	/* x5320[0] */ {  0.000000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5320[1] */ {  0.200000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5320[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5320[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5320[4] */ {  0.800000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5320[5] */ {  1.000000f,  0.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x5327[] = {
	/* x5327[0] */ {  0.000000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x5327[1] */ {  0.200000f,  -8.000000f,  0.000000f,  0.000000f, },
	/* x5327[2] */ {  0.400000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x5327[3] */ {  0.600000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x5327[4] */ {  0.800000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x5327[5] */ {  1.000000f,  8.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x5334[] = {
	/* x5334[0] */ {  0.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x5334[1] */ {  0.200000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x5334[2] */ {  0.400000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x5334[3] */ {  0.600000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x5334[4] */ {  0.800000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x5334[5] */ {  1.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
};
static CAnimKeyframe *x5341 = 0;
static CAnimKeyframe x5440[] = {
	/* x5440[0] */ {  0.000000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5440[1] */ {  0.200000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5440[2] */ {  0.400000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5440[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5440[4] */ {  0.800000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5440[5] */ {  1.000000f,  0.000000f,  -1.000000f,  0.000000f, },
};
static CAnimKeyframe x5447[] = {
	/* x5447[0] */ {  0.000000f,  18.000000f,  -8.000000f,  -0.270000f, },
	/* x5447[1] */ {  0.200000f,  6.000000f,  0.000000f,  0.000000f, },
	/* x5447[2] */ {  0.400000f,  -7.000000f,  0.000000f,  0.000000f, },
	/* x5447[3] */ {  0.600000f,  -13.000000f,  -4.500000f,  0.050000f, },
	/* x5447[4] */ {  0.800000f,  0.000000f,  -8.000000f,  -0.200000f, },
	/* x5447[5] */ {  1.000000f,  18.000000f,  -8.000000f,  -0.270000f, },
};
static CAnimKeyframe x5454[] = {
	/* x5454[0] */ {  0.000000f,  -11.000000f,  -2.500000f,  0.050000f, },
	/* x5454[1] */ {  0.200000f,  -14.000000f,  -5.000000f,  0.100000f, },
	/* x5454[2] */ {  0.400000f,  11.000000f,  -8.000000f,  -0.300000f, },
	/* x5454[3] */ {  0.600000f,  18.000000f,  -8.000000f,  -0.270000f, },
	/* x5454[4] */ {  0.800000f,  3.000000f,  0.000000f,  0.000000f, },
	/* x5454[5] */ {  1.000000f,  -11.000000f,  -2.500000f,  0.050000f, },
};
static CAnimKeyframe *x5461 = 0;
static CAnimKeyframe x5560[] = {
	/* x5560[0] */ {  0.000000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5560[1] */ {  0.200000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5560[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5560[3] */ {  0.600000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5560[4] */ {  0.800000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5560[5] */ {  1.000000f,  0.000000f,  -1.000000f,  0.000000f, },
};
static CAnimKeyframe x5567[] = {
	/* x5567[0] */ {  0.000000f,  -18.000000f,  -8.000000f,  0.270000f, },
	/* x5567[1] */ {  0.200000f,  0.000000f,  -8.000000f,  0.200000f, },
	/* x5567[2] */ {  0.400000f,  13.000000f,  -4.500000f,  -0.050000f, },
	/* x5567[3] */ {  0.600000f,  7.000000f,  0.000000f,  0.000000f, },
	/* x5567[4] */ {  0.800000f,  -6.000000f,  0.000000f,  0.000000f, },
	/* x5567[5] */ {  1.000000f,  -18.000000f,  -8.000000f,  0.270000f, },
};
static CAnimKeyframe x5574[] = {
	/* x5574[0] */ {  0.000000f,  11.000000f,  -2.500000f,  -0.050000f, },
	/* x5574[1] */ {  0.200000f,  -3.000000f,  0.000000f,  0.000000f, },
	/* x5574[2] */ {  0.400000f,  -18.000000f,  -8.000000f,  0.270000f, },
	/* x5574[3] */ {  0.600000f,  -11.000000f,  -8.000000f,  0.300000f, },
	/* x5574[4] */ {  0.800000f,  14.000000f,  -5.000000f,  -0.100000f, },
	/* x5574[5] */ {  1.000000f,  11.000000f,  -2.500000f,  -0.050000f, },
};
static CAnimKeyframe *x5581 = 0;
static CAnimKeyframe *x5680 = 0;
static CAnimKeyframe *x5687 = 0;
static CAnimKeyframe *x5694 = 0;
static CAnimKeyframe x5701[] = {
	/* x5701[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.100000f, },
	/* x5701[1] */ {  0.300000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x5701[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.300000f, },
	/* x5701[3] */ {  0.500000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x5701[4] */ {  1.000000f,  0.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x5735 = 0;
static CAnimKeyframe *x5742 = 0;
static CAnimKeyframe *x5749 = 0;
static CAnimKeyframe x5756[] = {
	/* x5756[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.250000f, },
	/* x5756[1] */ {  0.100000f,  0.000000f,  0.000000f,  -0.050000f, },
	/* x5756[2] */ {  0.150000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x5756[3] */ {  0.420000f,  0.000000f,  0.000000f,  0.400000f, },
	/* x5756[4] */ {  0.500000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x5756[5] */ {  1.000000f,  0.000000f,  0.000000f,  -0.250000f, },
};
static CAnimation x78[] = {
	/* x78[0] */ {  "base",  /* x78[0].body */ {  1,x5105, },  /* x78[0].back_foot */ {  1,x5112, },  /* x78[0].front_foot */ {  1,x5119, },  /* x78[0].attach */ {  0,x5126, }, },
	/* x78[1] */ {  "idle",  /* x78[1].body */ {  0,x5150, },  /* x78[1].back_foot */ {  1,x5157, },  /* x78[1].front_foot */ {  1,x5164, },  /* x78[1].attach */ {  0,x5171, }, },
	/* x78[2] */ {  "inair",  /* x78[2].body */ {  0,x5190, },  /* x78[2].back_foot */ {  1,x5197, },  /* x78[2].front_foot */ {  1,x5204, },  /* x78[2].attach */ {  0,x5211, }, },
	/* x78[3] */ {  "sit_left",  /* x78[3].body */ {  1,x5230, },  /* x78[3].back_foot */ {  1,x5237, },  /* x78[3].front_foot */ {  1,x5244, },  /* x78[3].attach */ {  0,x5251, }, },
	/* x78[4] */ {  "sit_right",  /* x78[4].body */ {  1,x5275, },  /* x78[4].back_foot */ {  1,x5282, },  /* x78[4].front_foot */ {  1,x5289, },  /* x78[4].attach */ {  0,x5296, }, },
	/* x78[5] */ {  "walk",  /* x78[5].body */ {  6,x5320, },  /* x78[5].back_foot */ {  6,x5327, },  /* x78[5].front_foot */ {  6,x5334, },  /* x78[5].attach */ {  0,x5341, }, },
	/* x78[6] */ {  "run_left",  /* x78[6].body */ {  6,x5440, },  /* x78[6].back_foot */ {  6,x5447, },  /* x78[6].front_foot */ {  6,x5454, },  /* x78[6].attach */ {  0,x5461, }, },
	/* x78[7] */ {  "run_right",  /* x78[7].body */ {  6,x5560, },  /* x78[7].back_foot */ {  6,x5567, },  /* x78[7].front_foot */ {  6,x5574, },  /* x78[7].attach */ {  0,x5581, }, },
	/* x78[8] */ {  "hammer_swing",  /* x78[8].body */ {  0,x5680, },  /* x78[8].back_foot */ {  0,x5687, },  /* x78[8].front_foot */ {  0,x5694, },  /* x78[8].attach */ {  5,x5701, }, },
	/* x78[9] */ {  "ninja_swing",  /* x78[9].body */ {  0,x5735, },  /* x78[9].back_foot */ {  0,x5742, },  /* x78[9].front_foot */ {  0,x5749, },  /* x78[9].attach */ {  6,x5756, }, },
};
static CDataSprite* *x5921 = 0;
static CDataSprite* x6066[] = {
	&x47[29],
	&x47[30],
	&x47[31],
};
static CDataSprite* x6262[] = {
	&x47[35],
	&x47[36],
	&x47[37],
};
static CDataSprite* *x6458 = 0;
static CDataSprite* *x6603 = 0;
static CDataSprite* x6748[] = {
	&x47[52],
	&x47[53],
	&x47[54],
};
static CDataWeaponspec x1994[] = {
	/* x1994[0] */ {  "hammer",  &x47[41],  &x47[42],  &x47[43],  0,x5921,  96,  125,  10,  0,  3,  4.000000f,  -20.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1994[1] */ {  "gun",  &x47[26],  &x47[27],  &x47[28],  3,x6066,  64,  125,  10,  500,  1,  32.000000f,  4.000000f,  58.875200f,  6.000000f,  5.000000f, },
	/* x1994[2] */ {  "shotgun",  &x47[32],  &x47[33],  &x47[34],  3,x6262,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  83.312800f,  6.000000f,  5.000000f, },
	/* x1994[3] */ {  "grenade",  &x47[38],  &x47[39],  &x47[40],  0,x6458,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1994[4] */ {  "laser",  &x47[47],  &x47[48],  &x47[49],  0,x6603,  92,  800,  10,  0,  5,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1994[5] */ {  "ninja",  &x47[44],  &x47[45],  &x47[46],  3,x6748,  96,  800,  10,  0,  9,  0.000000f,  0.000000f,  40.000000f,  -4.000000f,  5.000000f, },
};
