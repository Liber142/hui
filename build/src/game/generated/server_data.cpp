...
static CDataSprite x47[] = {
	...
	/* x47[139] */ {  "hud_dummy_control",  &x30[9],  14,  6,  2,  2, },
	/* x47[140] */ {  "hud_dummy_arrow",  &x30[9],  10,  8,  2,  2, },
	/* x47[141] */ {  "hud_dummy_hook",  &x30[9],  12,  8,  2,  2, },
	/* x47[142] */ {  "hud_dummy_hit",  &x30[9],  14,  8,  2,  2, },
	/* x47[143] */ {  "part_snowflake",  &x30[10],  0,  0,  2,  2, },
	/* x47[144] */ {  "part_sparkle",  &x30[10],  2,  0,  2,  2, },
};
static CAnimKeyframe x5169[] = {
	/* x5169[0] */ {  0.000000f,  0.000000f,  -4.000000f,  0.000000f, },
};
static CAnimKeyframe x5176[] = {
	/* x5176[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe x5183[] = {
	/* x5183[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe *x5190 = 0;
static CAnimKeyframe *x5214 = 0;
static CAnimKeyframe x5221[] = {
	/* x5221[0] */ {  0.000000f,  -7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x5228[] = {
	/* x5228[0] */ {  0.000000f,  7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe *x5235 = 0;
static CAnimKeyframe *x5254 = 0;
static CAnimKeyframe x5261[] = {
	/* x5261[0] */ {  0.000000f,  -3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x5268[] = {
	/* x5268[0] */ {  0.000000f,  3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x5275 = 0;
static CAnimKeyframe x5294[] = {
	/* x5294[0] */ {  0.000000f,  0.000000f,  3.000000f,  0.000000f, },
};
static CAnimKeyframe x5301[] = {
	/* x5301[0] */ {  0.000000f,  -12.000000f,  0.000000f,  0.100000f, },
};
static CAnimKeyframe x5308[] = {
	/* x5308[0] */ {  0.000000f,  -8.000000f,  0.000000f,  0.100000f, },
};
static CAnimKeyframe *x5315 = 0;
static CAnimKeyframe x5339[] = {
	/* x5339[0] */ {  0.000000f,  0.000000f,  3.000000f,  0.000000f, },
};
static CAnimKeyframe x5346[] = {
	/* x5346[0] */ {  0.000000f,  12.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x5353[] = {
	/* x5353[0] */ {  0.000000f,  8.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x5360 = 0;
static CAnimKeyframe x5384[] = {
	/* x5384[0] */ {  0.000000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5384[1] */ {  0.200000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5384[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5384[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5384[4] */ {  0.800000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5384[5] */ {  1.000000f,  0.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x5391[] = {
	/* x5391[0] */ {  0.000000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x5391[1] */ {  0.200000f,  -8.000000f,  0.000000f,  0.000000f, },
	/* x5391[2] */ {  0.400000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x5391[3] */ {  0.600000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x5391[4] */ {  0.800000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x5391[5] */ {  1.000000f,  8.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x5398[] = {
	/* x5398[0] */ {  0.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x5398[1] */ {  0.200000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x5398[2] */ {  0.400000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x5398[3] */ {  0.600000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x5398[4] */ {  0.800000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x5398[5] */ {  1.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
};
static CAnimKeyframe *x5405 = 0;
static CAnimKeyframe x5504[] = {
	/* x5504[0] */ {  0.000000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5504[1] */ {  0.200000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5504[2] */ {  0.400000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5504[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5504[4] */ {  0.800000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5504[5] */ {  1.000000f,  0.000000f,  -1.000000f,  0.000000f, },
};
static CAnimKeyframe x5511[] = {
	/* x5511[0] */ {  0.000000f,  18.000000f,  -8.000000f,  -0.270000f, },
	/* x5511[1] */ {  0.200000f,  6.000000f,  0.000000f,  0.000000f, },
	/* x5511[2] */ {  0.400000f,  -7.000000f,  0.000000f,  0.000000f, },
	/* x5511[3] */ {  0.600000f,  -13.000000f,  -4.500000f,  0.050000f, },
	/* x5511[4] */ {  0.800000f,  0.000000f,  -8.000000f,  -0.200000f, },
	/* x5511[5] */ {  1.000000f,  18.000000f,  -8.000000f,  -0.270000f, },
};
static CAnimKeyframe x5518[] = {
	/* x5518[0] */ {  0.000000f,  -11.000000f,  -2.500000f,  0.050000f, },
	/* x5518[1] */ {  0.200000f,  -14.000000f,  -5.000000f,  0.100000f, },
	/* x5518[2] */ {  0.400000f,  11.000000f,  -8.000000f,  -0.300000f, },
	/* x5518[3] */ {  0.600000f,  18.000000f,  -8.000000f,  -0.270000f, },
	/* x5518[4] */ {  0.800000f,  3.000000f,  0.000000f,  0.000000f, },
	/* x5518[5] */ {  1.000000f,  -11.000000f,  -2.500000f,  0.050000f, },
};
static CAnimKeyframe *x5525 = 0;
static CAnimKeyframe x5624[] = {
	/* x5624[0] */ {  0.000000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5624[1] */ {  0.200000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5624[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5624[3] */ {  0.600000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5624[4] */ {  0.800000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5624[5] */ {  1.000000f,  0.000000f,  -1.000000f,  0.000000f, },
};
static CAnimKeyframe x5631[] = {
	/* x5631[0] */ {  0.000000f,  -18.000000f,  -8.000000f,  0.270000f, },
	/* x5631[1] */ {  0.200000f,  0.000000f,  -8.000000f,  0.200000f, },
	/* x5631[2] */ {  0.400000f,  13.000000f,  -4.500000f,  -0.050000f, },
	/* x5631[3] */ {  0.600000f,  7.000000f,  0.000000f,  0.000000f, },
	/* x5631[4] */ {  0.800000f,  -6.000000f,  0.000000f,  0.000000f, },
	/* x5631[5] */ {  1.000000f,  -18.000000f,  -8.000000f,  0.270000f, },
};
static CAnimKeyframe x5638[] = {
	/* x5638[0] */ {  0.000000f,  11.000000f,  -2.500000f,  -0.050000f, },
	/* x5638[1] */ {  0.200000f,  -3.000000f,  0.000000f,  0.000000f, },
	/* x5638[2] */ {  0.400000f,  -18.000000f,  -8.000000f,  0.270000f, },
	/* x5638[3] */ {  0.600000f,  -11.000000f,  -8.000000f,  0.300000f, },
	/* x5638[4] */ {  0.800000f,  14.000000f,  -5.000000f,  -0.100000f, },
	/* x5638[5] */ {  1.000000f,  11.000000f,  -2.500000f,  -0.050000f, },
};
static CAnimKeyframe *x5645 = 0;
static CAnimKeyframe *x5744 = 0;
static CAnimKeyframe *x5751 = 0;
static CAnimKeyframe *x5758 = 0;
static CAnimKeyframe x5765[] = {
	/* x5765[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.100000f, },
	/* x5765[1] */ {  0.300000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x5765[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.300000f, },
	/* x5765[3] */ {  0.500000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x5765[4] */ {  1.000000f,  0.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x5799 = 0;
static CAnimKeyframe *x5806 = 0;
static CAnimKeyframe *x5813 = 0;
static CAnimKeyframe x5820[] = {
	/* x5820[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.250000f, },
	/* x5820[1] */ {  0.100000f,  0.000000f,  0.000000f,  -0.050000f, },
	/* x5820[2] */ {  0.150000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x5820[3] */ {  0.420000f,  0.000000f,  0.000000f,  0.400000f, },
	/* x5820[4] */ {  0.500000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x5820[5] */ {  1.000000f,  0.000000f,  0.000000f,  -0.250000f, },
};
static CAnimation x78[] = {
	/* x78[0] */ {  "base",  /* x78[0].body */ {  1,x5169, },  /* x78[0].back_foot */ {  1,x5176, },  /* x78[0].front_foot */ {  1,x5183, },  /* x78[0].attach */ {  0,x5190, }, },
	/* x78[1] */ {  "idle",  /* x78[1].body */ {  0,x5214, },  /* x78[1].back_foot */ {  1,x5221, },  /* x78[1].front_foot */ {  1,x5228, },  /* x78[1].attach */ {  0,x5235, }, },
	/* x78[2] */ {  "inair",  /* x78[2].body */ {  0,x5254, },  /* x78[2].back_foot */ {  1,x5261, },  /* x78[2].front_foot */ {  1,x5268, },  /* x78[2].attach */ {  0,x5275, }, },
	/* x78[3] */ {  "sit_left",  /* x78[3].body */ {  1,x5294, },  /* x78[3].back_foot */ {  1,x5301, },  /* x78[3].front_foot */ {  1,x5308, },  /* x78[3].attach */ {  0,x5315, }, },
	/* x78[4] */ {  "sit_right",  /* x78[4].body */ {  1,x5339, },  /* x78[4].back_foot */ {  1,x5346, },  /* x78[4].front_foot */ {  1,x5353, },  /* x78[4].attach */ {  0,x5360, }, },
	/* x78[5] */ {  "walk",  /* x78[5].body */ {  6,x5384, },  /* x78[5].back_foot */ {  6,x5391, },  /* x78[5].front_foot */ {  6,x5398, },  /* x78[5].attach */ {  0,x5405, }, },
	/* x78[6] */ {  "run_left",  /* x78[6].body */ {  6,x5504, },  /* x78[6].back_foot */ {  6,x5511, },  /* x78[6].front_foot */ {  6,x5518, },  /* x78[6].attach */ {  0,x5525, }, },
	/* x78[7] */ {  "run_right",  /* x78[7].body */ {  6,x5624, },  /* x78[7].back_foot */ {  6,x5631, },  /* x78[7].front_foot */ {  6,x5638, },  /* x78[7].attach */ {  0,x5645, }, },
	/* x78[8] */ {  "hammer_swing",  /* x78[8].body */ {  0,x5744, },  /* x78[8].back_foot */ {  0,x5751, },  /* x78[8].front_foot */ {  0,x5758, },  /* x78[8].attach */ {  5,x5765, }, },
	/* x78[9] */ {  "ninja_swing",  /* x78[9].body */ {  0,x5799, },  /* x78[9].back_foot */ {  0,x5806, },  /* x78[9].front_foot */ {  0,x5813, },  /* x78[9].attach */ {  6,x5820, }, },
};
static CDataSprite* *x5985 = 0;
static CDataSprite* x6130[] = {
	&x47[29],
	&x47[30],
	&x47[31],
};
static CDataSprite* x6326[] = {
	&x47[35],
	&x47[36],
	&x47[37],
};
static CDataSprite* *x6522 = 0;
static CDataSprite* *x6667 = 0;
static CDataSprite* x6812[] = {
	&x47[52],
	&x47[53],
	&x47[54],
};
static CDataWeaponspec x1994[] = {
	/* x1994[0] */ {  "hammer",  &x47[41],  &x47[42],  &x47[43],  0,x5985,  96,  125,  10,  0,  3,  4.000000f,  -20.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1994[1] */ {  "gun",  &x47[26],  &x47[27],  &x47[28],  3,x6130,  64,  125,  10,  500,  1,  32.000000f,  4.000000f,  58.875200f,  6.000000f,  5.000000f, },
	/* x1994[2] */ {  "shotgun",  &x47[32],  &x47[33],  &x47[34],  3,x6326,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  83.312800f,  6.000000f,  5.000000f, },
	/* x1994[3] */ {  "grenade",  &x47[38],  &x47[39],  &x47[40],  0,x6522,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1994[4] */ {  "laser",  &x47[47],  &x47[48],  &x47[49],  0,x6667,  92,  800,  10,  0,  5,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1994[5] */ {  "ninja",  &x47[44],  &x47[45],  &x47[46],  3,x6812,  96,  800,  10,  0,  9,  0.000000f,  0.000000f,  40.000000f,  -4.000000f,  5.000000f, },
};
